...
const AdminProduct = () => {
    ...
    const dataTable = product?.data?.length && product?.data?.map((products) => {
    ...
    return (
        ...
        <div style={{ marginTop: '20px'}}>
                <TableCombonent handleDelteMany={handleDelteManyProducts} columns={columns} isLoading={isLoadingProduct} data={dataTable} onRow={(record, rowIndex) => {
                    return {
                        onClick: event => {
            ...
            <Loading isLoading={isLoadingUpdate}>
                ...
                >
                    ...
                    <Form.Item
                        ...
                        rules={[{ required: true, message: 'Please input your rating!' }]}
                    >
                    <Input value={stateProductDetails.priratingce} onChange={handleOnchangeDetails} name="rating"/>
                    </Form.Item>
